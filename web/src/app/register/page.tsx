...
export default function RegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            const accountNum = `VN-${Math.floor(1000 + Math.random() * 9000)}`;

            // Step 1: Create auth user — pass profile data as metadata so the
            // DB trigger (handle_new_user) can insert the profile row safely,
            // bypassing the RLS INSERT policy that blocks unauthenticated inserts.
            ...
            const { data: clinicData, error: clinicError } = await supabase
                ...
                .insert({
                    ...
                    contact: phone,
                    email: email,
                    operating_hours: operatingHours || "Mon–Fri 9am–5pm",
            ...
            // Step 3: Link this vet to the clinic via clinic_staff (junction table)
