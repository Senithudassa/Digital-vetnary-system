        ...
        <div className="space-y-8 p-4 max-w-7xl mx-auto">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex gap-2 text-sm">
                    <Button variant="outline"><Headset className="h-4 w-4 mr-2" /> Active Status</Button>
                </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">3 Proposed</div>
                            ...
                            {supportTickets.map((ticket) => (
                                <TableRow key={ticket.id}>
                                    ...
                                    <TableCell className="text-right space-x-2">
                                        ...
                                        <Button size="sm">Route to Branch</Button>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
            ...
            <div className="grid gap-8 grid-cols-1 lg:grid-cols-2">
                ...
                <Card className="border-amber-500/30">
                    ...
                    <CardFooter className="pt-0">
                        <Button variant="outline" className="w-full mt-4 border-dashed">Propose New Configuration Change</Button>
                    </CardFooter>
                </Card>
